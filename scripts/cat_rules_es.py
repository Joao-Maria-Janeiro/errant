...
# Contractions
# conts = {"'s", "´s"} 
# Rare POS tags that make uninformative error categories - all tags taken from universal pos tags: https://universaldependencies.org/u/pos/
rare_tags = {"INTJ", "NUM", "SYM", "X"}
# POS tags with inflectional morphology
inflected_tags = {"ADJ", "ADV", "AUX", "DET", "PRON", "PROPN", "NOUN", "VERB"}
# Fine-grained spanish tree tagger verb tags - https://www.sketchengine.eu/spanish-treetagger-part-of-speech-tagset/
verb_tags = {"VEadj", "VEfin", "VEger", "VEinf", "VHadj", "VHfin", "VHger", "VHinf", "VLadj", "VLfin", "VLger", "VLinf", "VMadj", "VMfin", "VMger", "VMinf", "VSadj", "VSfin", "VSger", "VSinf"}
