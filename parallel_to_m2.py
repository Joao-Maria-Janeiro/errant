...
def main(args):
	...
	if args.lang == "en":
		...
		treetagger = treetaggerwrapper.TreeTagger(TAGLANG="de",TAGDIR="../../tree_tagger")
		# Load Tokenizer and other resources
		...
		import scripts.cat_rules_es as cat_rules
		import treetaggerwrapper
		treetagger = treetaggerwrapper.TreeTagger(TAGLANG="es",TAGDIR="../../tree_tagger")
		# Load Tokenizer and other resources
		nlp = spacy.load("es", disable=spacy_disable)
		# Spanish Snowball Stemmer
		stemmer = SnowballStemmer("spanish")
		# ES word list from hunspell
		word_list = toolbox.loadDictionary(basename+"/resources/es_ES.txt")
		# Part of speech map file (not needed for spacy 2.0)
		tag_map = toolbox.loadTagMap(basename+"/resources/es-treetagger_map", args)
...
if __name__ == "__main__":
	...
	parser.add_argument("-lang", choices=["en", "de", "es"], default="en", help="Input language. Currently supported: en (default), de\n")
